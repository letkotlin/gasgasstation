...
class NavAdapter(private val items: ArrayList<String> = ArrayList<String>()) : RecyclerView.Adapter<NavAdapter.InitialSettingViewHolder>(), NavAdapterModel, NavAdapterView {
